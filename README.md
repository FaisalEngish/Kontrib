...
Add members via shareable WhatsApp links.

Set contribution goals, deadlines, and payment types.

Manage multiple groups under one account.

🔹 Member Access & Authentication

Secure login using Username + WhatsApp Phone Number.

OTP verification delivered through WhatsApp.

Easy onboarding for non-technical users.

🔹 WhatsApp Integration

Automatic sending of OTP via WhatsApp API.

Share group invitation links directly into WhatsApp groups.

Future extensions: automatic reminders, payment confirmations, etc.

🔹 Contribution Tracking

Real-time tracking of who has paid and who hasn’t.

Automatic updates when payments are recorded.

Visual insights: totals, balances, pending amounts.

🔹 Transparency & Accountability

Members can view contribution status anytime.

Prevents misunderstandings and money-handling conflicts.

Full visibility of group financial activities.

🔹 Financial Reports

Downloadable or viewable contribution history.
